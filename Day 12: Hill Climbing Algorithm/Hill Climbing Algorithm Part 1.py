...
def build_adjacency_list(grid):
    ...
    return cord_to_str(source), cord_to_str(destination), adjacency_list
...
if __name__ == '__main__':
    with open(input_file, 'r') as fd:
        ...
        source, destination, adjacency_list = build_adjacency_list(grid)

        destinations, path = modified_bfs_algorithm(adjacency_list, source, destination)
